...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        if self.order_total < settings.FREE_DELIVERY_THRESHOLD:
            self.delivery.cost = self.order_total * settings.STANDARD_DELIVERY_PERCENTAGE / 100
        else:
    ...
    def save(self, *args, **kwargs):
        """ Override the original save method to set the order number if it has not been set already. """
